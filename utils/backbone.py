...
# Loading label map Label maps map indices to category names, so that when our convolution network
    # predicts 5, we know that this corresponds to airplane. Here I 		use internal utility
