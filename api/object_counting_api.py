...
def cumulative_object_counting_x_axis(input_video, detection_graph, category_index,
    ...
    with detection_graph.as_default():
        with tf.compat.v1.Session(graph=detection_graph) as sess:
            ...
            while True:
                ...
                #     cv2.putText(input_frame, labels[i], (startXs[i], startYs[i] - 10), cv2.FONT_HERSHEY_SIMPLEX,
                #                 0.45, colors[i], 2)
                #     cv2.rectangle(input_frame, (startXs[i], startYs[i]), (endXs[i], endYs[i]), colors[i], 2)

                cv2.imshow('object counting', input_frame)
                # detect_mask_image.mask_image_filename('./images/pic1.jpeg')
...
#
#     # Visualization of the results of a detection.
#     counter, csv_line, counting_mode = vis_util.visualize_boxes_and_labels_on_single_image_array(1,
#                                                                                                  input_frame,
#                                                                                                  1,
#                                                                                                  is_color_recognition_enabled,
#                                                                                                  np.squeeze(
